...
2. Wie viele Studenten bekommen zumindest 10 NP?
    ...
    `r pnorm(10,sd=3,mean=mu,lower.tail=FALSE)*n` Studenten bekommen zumindest 10 Notenpunkte.


3. Wie viele Studenten bekommen weniger als 10 NP?

    `r pnorm(10,sd=3,mean=mu)*n` Studenten bekommen weniger als 10 Notenpunkte.

4. Wie viele Studenten bekommen weniger als 8 NP?

    `r pnorm(8,sd=3,mean=mu)*n` Studenten bekommen weniger als 8 Notenpunkte.
...
Der kritische Wert für einen einseitigen $z$-Test ist `r qnorm(0.94)` ($\alpha=0.06$).

Die kritischen Werte für einen zweiseitigen $z$-Test sind $\pm$ `r qnorm(0.970)` ($\alpha=0.06$).
