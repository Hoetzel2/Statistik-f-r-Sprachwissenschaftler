...
# 2014-05-05
# Dieses Werk ist lizenziert unter einer DU-ER-ES-IN Lizenz.
...
frauen.studiengang.bw <- ggplot(frauen, aes(x=major, y=height)) + geom_boxplot()
...
frauen.studiengang.dichte <- ggplot(frauen, aes(x=height, fill=major)) + geom_density(alpha=.3)
